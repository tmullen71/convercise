...
module.exports = function(app) {
	...
	app.route('/doneTasks/:doneTaskId')
		.put(users.requiresLogin, exchanges.hasAuthorizationDoneTask, exchanges.updateDoneTask)
		.delete(users.requiresLogin, exchanges.hasAuthorizationDoneTask, exchanges.deleteDoneTask);



	// Finish by binding the Exchange middleware
	app.param('exchangeId', exchanges.exchangeByID);
	app.param('doneTaskId', exchanges.doneTaskByID);
};
